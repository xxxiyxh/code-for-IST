...
This repository contains the source code and related data for the QP Weighted Adder. The project includes various versions of the code with different defects implanted and tools for evaluating and testing the function's performance, particularly in the context of defect detection and measurement.

## Files and Their Functions

- `adder.py`: This is the bug-free version of the code implementing the Linear Amplitude Function.
- `weightedAdder_defect.py` to `weightedAdder_defect4.py`: These are versions of the code with four different types of defects implanted, intended for testing and evaluation purposes.
