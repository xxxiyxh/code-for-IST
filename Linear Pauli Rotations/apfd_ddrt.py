...
for _ in range(num_iterations):
    selected_data = read_csv_and_select_data('Linear Pauli Rotations (part1).csv', m=600, epsilon=epsilon, delta=delta, epsilon_matrix_file='epsilon_matrix.csv', delta_matrix_file='delta_matrix.csv')
